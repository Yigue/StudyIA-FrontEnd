...
import { FlashcardFilters } from '../../../../types/flashcards/flashcards';
...
const FilterPanel: React.FC<FilterPanelProps> = ({ 
  ...
  return (
    <div className={`space-y-4 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg ${className}`}>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          >
            ...
            <option value="easy">Fácil (Categoría)</option>
            <option value="normal">Normal (Categoría)</option>
            <option value="hard">Difícil (Categoría)</option>
          </select>
        </div>
